...
def edytuj_uzytkownika():
    ...
    button_edytuj_uzytkownika.config(text="zapisz zmiany", command=lambda:aktualizuj_uzytkownika(i))
...
button_edytuj_uzytkownika = Button(ramka_lista_uzytkownikow, text='Edytuj', commmand = edytuj_uzytkownika)

label_lista_obiektow = Label(ramka_formularz, text= 'Lista znajomych: ')
...
button_dodaj_uzytkownika.grid(row=1, column=0, columnspan=2)
...
label_opis_obiektu = Label(ramka_szczegoly_obiektu, text= 'Opis: ')
